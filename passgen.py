...
parser.add_argument("-wG", "--wordlistGeneration", action="store_true", help="Password generation for wordlist creation")
...
if args.passwordGeneration:
	...
	transfer = args.fileTransfer

	if transfer:
		print("The Content is add to your file")
	else:
		print(passwords)
...
if args.wordlistGeneration:
	...
	x = int(input("Indicates the number of characters required : "))
